...
option(MUJOCO_MIRI_SUPPORT "Enable Miri-compatible allocation hooks" OFF)
if(MUJOCO_MIRI_SUPPORT)
  set(EXTRA_COMPILE_OPTIONS ${EXTRA_COMPILE_OPTIONS} -DMUJOCO_MIRI_SUPPORT)
endif()
